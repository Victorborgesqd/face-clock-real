...
import { Clock, Users, History, LayoutDashboard, LogOut, UserPlus, Store } from 'lucide-react';

interface TimeClockLayoutProps {
  children: React.ReactNode;
}

const TimeClockLayout: React.FC<TimeClockLayoutProps> = ({ children }) => {
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <header className="bg-card border-b border-border px-4 py-3 flex items-center justify-between sticky top-0 z-50">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-foreground">Sistema de Ponto</span>
        </div>
        <div className="flex items-center gap-2">
          <Link to="/loja">
...
export default TimeClockLayout;
